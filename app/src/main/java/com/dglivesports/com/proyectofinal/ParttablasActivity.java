...
public class ParttablasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parttablas);
        ...
        ActionBar.Tab tab = actionBar.newTab().setText("Tablas").setTabListener(tabListener);
        actionBar.addTab (tab);
        tab = actionBar.newTab().setText("Equipos").setTabListener(tabListener);
        actionBar.addTab (tab);
        tab = actionBar.newTab().setText("Partidos").setTabListener(tabListener);
        actionBar.addTab (tab);
